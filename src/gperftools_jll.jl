...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import gperftools_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c8ae51e6-ca1b-5cf7-8aa4-ff5973bfb1e4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "gperftools", artifacts_toml) for e in artifacts["gperftools"]]
...
if best_platform === nothing
    @debug("Unable to load gperftools; unsupported platform $(triplet(platform_key_abi()))")
else
